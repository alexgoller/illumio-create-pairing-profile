...
def parse_arguments():
    ...
    parser.add_argument('--pce_host', help='Integer for the PCE demo host')
    parser.add_argument('--pce_port', default=443, help='TCP port for the PCE connection')
    parser.add_argument('--org_id', default=1, help='Organization ID for the PCE')
    parser.add_argument('--username', default='demo@illumio.com', help='Optional username (default: demo@illumio.com)')
    parser.add_argument('--password', default='password', help='Optional password (default: password)')
